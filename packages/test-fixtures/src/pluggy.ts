...
export const pluggyLifecycleMappingFixtures = [
  {
    errorCode: null,
    event: 'item/deleted',
    executionStatus: null,
    expectedLocalStatus: 'DELETED',
    itemStatus: null,
    name: 'deleted event is terminal even after provider data disappears',
  },
  {
    errorCode: null,
  ...
  },
  {
    ...
    name: 'device action is required',
  },
  {
    errorCode: null,
    event: 'item/error',
    ...
    expectedLocalStatus: 'USER_ACTION_REQUIRED',
    itemStatus: 'OUTDATED',
    name: 'authorization remains pending',
  },
  {
    errorCode: 'USER_AUTHORIZATION_NOT_GRANTED',
    event: 'item/error',
    executionStatus: 'USER_AUTHORIZATION_NOT_GRANTED',
    expectedLocalStatus: 'USER_ACTION_REQUIRED',
    itemStatus: 'OUTDATED',
    name: 'authorization was not granted',
  },
  {
  ...
  {
    errorCode: 'ACCOUNT_CREDENTIALS_RESET',
    event: 'item/error',
    executionStatus: 'ACCOUNT_CREDENTIALS_RESET',
    expectedLocalStatus: 'REAUTH_REQUIRED',
    itemStatus: 'LOGIN_ERROR',
    name: 'institution reset credentials',
  },
  {
  ...
  },
  {
    ...
    expectedLocalStatus: 'SYNCING',
    itemStatus: 'UPDATING',
    name: 'login succeeded while collection continues',
  },
  ...[
    'CREATED',
    'LOGIN_IN_PROGRESS',
    ...
    event: 'item/updated',
    executionStatus,
    expectedLocalStatus: 'SYNCING' as const,
    itemStatus: 'UPDATING',
    name: `${executionStatus} is transitive`,
  })),
  {
    errorCode: null,
    event: 'item/updated',
    ...
    expectedLocalStatus: 'ACTIVE',
    itemStatus: 'UPDATED',
    name: 'successful collection is active',
  },
  {
    errorCode: 'TRANSACTIONS_WARNING',
    event: 'item/updated',
    executionStatus: 'PARTIAL_SUCCESS',
    expectedLocalStatus: 'ACTIVE',
    itemStatus: 'UPDATED',
    name: 'partial success remains usable and preserves warning evidence',
  },
  ...['ERROR', 'MERGE_ERROR', 'CONNECTION_ERROR'].map((executionStatus) => ({
    errorCode: executionStatus,
    event: 'item/error',
    executionStatus,
    expectedLocalStatus: 'PROVIDER_ERROR' as const,
    itemStatus: 'OUTDATED',
    name: `${executionStatus} is a provider failure`,
  })),
  {
    ...
    expectedLocalStatus: 'PROVIDER_ERROR',
    itemStatus: 'OUTDATED',
    name: 'transient institution error remains retryable provider failure',
  },
  {
    errorCode: 'FUTURE_ERROR',
    event: 'item/future_event',
    executionStatus: 'FUTURE_EXECUTION_STATUS',
    expectedLocalStatus: 'PROVIDER_ERROR',
    itemStatus: 'FUTURE_ITEM_STATUS',
    name: 'unknown combinations fail closed',
  },
] as const;
